 ...
 *      even if the element already has a transition css &#42;/
 ...
 * ```
 *
 * The setup CSS class (in this case `.fade-add`) also has a transition css property, however, it
 ...
 * the animation. The css property expected within the stagger class can either be a **transition-delay** or an
  ...
  .config(['$provide', '$animateProvider', function($provide, $animateProvider) {
    ...
    $provide.decorator('$animate', ['$delegate', '$injector', '$sniffer', '$rootElement', '$$asyncCallback', '$rootScope', '$document',
      ...
      return {
         ...
         * | 13.0. The doneCallback() callback is fired (if provided)                                                            | class="my-animation"                                     |
         *
        ...
        */
         ...
         * | 13.0. The doneCallback() callback is fired (if provided)                                                            | ...                                                      |
         *
