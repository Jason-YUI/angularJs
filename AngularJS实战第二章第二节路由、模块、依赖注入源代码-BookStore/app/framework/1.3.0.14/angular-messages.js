 ...
 * ```html
 * <form name="myForm">
 *   <input type="test" ng-model="field" name="myField" required minlength="5" />
 ...
 *
 * ```html
 * <script type="test/ng-template" id="error-messages">
 ...
 * <script type="test/ng-template" id="my-custom-messages">
 *   <div ng-message="required">This field is required</div>
 *   <div ng-message="minlength">This field is too short</div>
 * </script>
 *
...
angular.module('ngMessages', [])
    ...
    *
    *       <div ng-messages="myForm.myName.$error" css="color:maroon">
    *         <div ng-message="required">You did not enter a field</div>
