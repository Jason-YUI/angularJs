...
eq('test/plain', mime.lookup('text.txt'));     // normal file
eq('test/plain', mime.lookup('TEXT.TXT'));     // uppercase
eq('test/plain', mime.lookup('dir/test.txt')); // dir + file
eq('test/plain', mime.lookup('.text.txt'));    // hidden file
eq('test/plain', mime.lookup('.txt'));         // nameless
eq('test/plain', mime.lookup('txt'));          // extension-only
eq('test/plain', mime.lookup('/txt'));         // extension-less ()
eq('test/plain', mime.lookup('\\txt'));        // Windows, extension-less
...
eq('bin', mime.extension('application/octet-stream '));
eq('html', mime.extension(' test/html; charset=UTF-8'));
eq('html', mime.extension('test/html; charset=UTF-8 '));
eq('html', mime.extension('test/html; charset=UTF-8'));
eq('html', mime.extension('test/html ; charset=UTF-8'));
eq('html', mime.extension('test/html;charset=UTF-8'));
...
eq('UTF-8', mime.charsets.lookup('test/plain'));
