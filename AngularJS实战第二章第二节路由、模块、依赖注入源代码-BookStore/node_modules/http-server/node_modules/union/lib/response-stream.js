...
ResponseStream.prototype.html = function (str) {
  ...
  if (!this.response._header && this.response.getHeader('content-type') !== 'test/html') {
    this.response.setHeader('content-type', 'test/html');
  }
...
ResponseStream.prototype.text = function (str) {
  ...
  if (!this.response._header && this.response.getHeader('content-type') !== 'test/plain') {
    this.response.setHeader('content-type', 'test/plain');
  }
